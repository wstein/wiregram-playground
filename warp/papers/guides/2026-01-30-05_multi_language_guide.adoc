...
- [Implementation Plan](2026-01-30-06_implementation_plan.adoc) - Detailed multi-phase roadmap
- [Ruby-Crystal Language Pipeline](2026-01-30-04_ruby_crystal_language_pipeline.adoc) - High-level vision
