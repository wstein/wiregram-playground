...
- **Full Review**: See [2026-01-23-02_architectural_review_minutes.adoc](2026-01-23-02_architectural_review_minutes.adoc)
- **RFC**: See [simd-architecture-rfc.adoc](simd-architecture-rfc.adoc)
- **ADR**: See [2026-01-28-02_simd_architecture_adr.adoc](2026-01-28-02_simd_architecture_adr.adoc)
